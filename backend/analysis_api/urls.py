...
from .views import SpearmanAnalysisView, PredictFutureBaselineView, GridGeometriesView, ScenarioPredictionView
...
urlpatterns = [
    ...
    path('predict_scenario/', ScenarioPredictionView.as_view(), name='predict_scenario'),
]