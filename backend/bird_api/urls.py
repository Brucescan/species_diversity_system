...
urlpatterns = [
    ...
    # 记录相关接口
    path('bird_records/', RecordCreateAPIView.as_view(), name='bird-record-create'),
    path('bird_records/basic/', RecordListBasicAPIView.as_view(), name='bird-record-list-basic'),
    ...
    path('bird_records/<int:pk>/comments/', CommentCreateAPIView.as_view(), name='comment-create'),
]
